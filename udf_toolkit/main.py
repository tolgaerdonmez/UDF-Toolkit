...
from udf_toolkit.paragraph_processor import process_paragraph
from udf_toolkit.table_processor import process_table

def convert(docx_file, udf_file):
    """Convert a DOCX file to UDF format.
    
    Args:
        docx_file: Path to the input DOCX file
        udf_file: Path to the output UDF file
    """
